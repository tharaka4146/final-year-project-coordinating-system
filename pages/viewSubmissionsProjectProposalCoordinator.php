...
<head>
    ...
    <title>Project Proposal Submissions</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Project Proposal Submissions</h1>
                    ...
                    <div class="row">
                        ...
                        for ($i = 0; $i < $countSend; ++$i) {
                            ...
                            $sql = "SELECT norm.kduEmail as kduEmail, norm.admissionNo as admissionNo, norm.firstName as firstName, norm.lastName as lastName, norm.projectTitle as projectTitle, projectproposal.dateTime dateTime, projectproposal.review as review  FROM $formName inner join norm on $formName.kduEmail = norm.kduEmail where projectproposal.review != 0 order by projectproposal.indexNo desc limit $i1 OFFSET $i ";
                            $result = $con->query($sql);
