    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="homeStudent.php">
                ...
                <div class="sidebar-brand-text mx-3">olio <sup></sup></div>
            </a>
                                        ...
                                        <div class="col-md-12 offset-md-0">
                                            <ul class="timeline">
                                                ...
                                                <li>
                                                    ...
                                                    <h5 style="opacity:0.6"><?php echo $previous ?></h5>
                                                    <br>
                                                </li>

                                                <li>
                                                    <p>Current activity</p>
                                                    <h5><?php echo $currents ?></h5>
                                                    <br>
                                                ...
                                                <li>
                                                    ...
                                                    <h5 style="opacity:0.6"><?php echo $next ?></h5>
                                                    <br>
