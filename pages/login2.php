            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block bg-ldogin-image"
                                style="background-color: rgb(153, 153, 250);">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Welcome to<span
                                                style="color:rgb(50, 50, 218);"> Arc-hive<span></h1>
                                    ...
                                    <form class="user">
                                        ...
                                        <div class="form-group">
                                            <input type="email" autocomplete="yes" id="txt_uname" name="txt_uname"
                                                class="form-control form-control-user" id="exampleInputEmail"
                                                aria-describedby="emailHelp" placeholder="Enter KDU email">
                                        </div>
                                        ...
                                        <input type="button" class="btn btn-primary btn-user btn-block" value="Login"
                                            name="but_submit" id="but_submit" style="font-size:15px;" />
