...
<body id="page-top">
    ...
    <script src="../vendor/bootstrap/js/bootstrap.bundle.min.js?n=1"></script>

    <!-- Core plugin JavaScript-->
    <script src="../vendor/jquery-easing/jquery.easing.min.js?n=1"></script>

    <!-- Custom scripts for all pages-->
    <script src="../js/sb-admin-2.min.js"></script>

    <!-- Page level plugins -->
    <script src="../vendor/chart.js/Chart.min.js?n=1"></script>

    <!-- Page level custom scripts -->
    <script src="../js/demo/chart-area-demo.js?n=1"></script>
    <script src="../js/demo/chart-pie-demo.js?n=1"></script>
