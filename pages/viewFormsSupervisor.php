...
//norm start
$sql = "SELECT count(*) as countNorm FROM norm WHERE send = 1 and examiner1 = '" . $name . "'";
$result = $con->query($sql);
                    ...
                    <div class='row pricing-tables'>
                        ...
                        <div class='col-lg-4'>
                            ...
                            <div class="pricing-table <?php echo $oneColor; ?> pricing-table-primary">
                                ...
                                <a class="btn btn-primary" <?php echo $oneButton; ?> href='viewSubmissionsExaminer.php' <?php echo $oneButton; ?>>
                                    Review
                                </a>
                        ...
                        <div class='col-lg-4'>
                            <div class="pricing-table <?php echo $twoColor; ?> pricing-table-warning">
                                ...
                                <ul class='pricing-table-features'>
                                    ...
                                    <li>upload your project proposal</li>
                                    <li></li>

                                </ul><a class="btn btn-warning <?php echo $twoButton; ?>" href='viewSubmissionsProjectProposal.php' <?php echo $twoButton;
                                                                                                                                    ?>>Review</a>
                            </div>
                        </div>
                        ...
                        <div class='col-lg-4'>
                            <div class="pricing-table <?php echo $threeColor; ?> pricing-table-success">
                                ...
                                </ul><a class="btn btn-success <?php echo $threeButton; ?>" href='viewSubmissionsResearch.php' <?php echo $threeButton;
                                                                                                                                ?>>Review</a>
                            </div>
                        </div>
                    ...
                    <div class='row pricing-tables'>
                        ...
                        <div class='col-lg-4'>
                            <div class="pricing-table <?php echo $fourColor; ?> pricing-table-danger">
                                ...
                                </ul><a class="btn btn-danger <?php echo $fourButton; ?>" href='viewSubmissionsInterim1.php' <?php echo $fourButton;
                                                                                                                                ?>>Review</a>
                            </div>
                        </div>
                        ...
                        <div class='col-lg-4'>
                            ...
                            <div class="pricing-table <?php echo $fiveColor; ?> pricing-table-primary">
                                ...
                                </ul><a class="btn btn-primary <?php echo $fiveButton; ?>" href='viewSubmissionsInterim2.php' <?php echo $fiveButton;
                                                                                                                                ?>>Review</a>
                            </div>
                        ...
                        <div class='col-lg-4'>
                            <div class="pricing-table <?php echo $sixColor; ?> pricing-table-warning">
                                ...
                                </ul><a class="btn btn-warning <?php echo $sixButton; ?>" href='viewSubmissionsResearchWork.php' <?php echo $sixButton;
                                                                                                                                    ?>>Review</a>
                            </div>
                        </div>
                    ...
                    <div class='row pricing-tables'>
                        ...
                        <div class='col-lg-4'>
                            <div class="pricing-table <?php echo $sevenColor; ?> pricing-table-success">
                                ...
                                </ul><a class="btn btn-success <?php echo $sevenButton; ?>" href='viewSubmissionsThesis.php' <?php echo $sevenColor;
                                                                                                                                ?>>Review</a>
                            </div>
                        </div>
                        ...
                        <div class='col-lg-4'>
                            <div class="pricing-table <?php echo $eightColor; ?> pricing-table-danger">
                                ...
                                </ul><a class="btn btn-danger <?php echo $eightButton; ?>" href='viewSubmissionsThesisFinal.php' <?php echo $eightButton;
                                                                                                                                    ?>>Review</a>
                            </div>
                        </div>
