                                                ...
                                                <div class="hoverbox-content bg-dark p-5 align-items-center" style="text-align: center;">
                                                    ...
                                                    <div>
                                                        ...
                                                        <form method="POST">
                                                            ...
                                                            <a class="btn btn-primary btn-md mt-1" href="viewinterim2.php?filename=<?php echo $kduEmail; ?>">View
                                                                submission</a>
                                                            <button type='submit' formaction='../databases/interim2Approve.php' class="btn btn-primary btn-md mt-1" id='send'>Approve</button>
                                                            <button type='submit' formaction='../databases/interim2Disapprove.php' class="btn btn-primary btn-md mt-1" id='send'>Disaprove</button>
                                                        </form>
                                                    </div>
