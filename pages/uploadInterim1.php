...
-->
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                $sql = "SELECT * FROM interim1 WHERE kduEmail ='" . $_SESSION['uname'] . "' and review != 0";
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Upload interim report 1 in pdf form</h1>
                    ...
                    <center>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <form method='post' action='uploadInterim1BackEnd.php' enctype='multipart/form-data' class="box">
