...
<div id="content">
    ...
    <!-- End of Topbar -->
                ...
                $sql = "SELECT * FROM interim2 WHERE kduEmail ='" . $_SESSION['uname'] . "' and review != 0";
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Upload interim report 2 in pdf form</h1>
                    ...
                    <center>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <form method='post' action='uploadinterim2BackEnd.php' enctype='multipart/form-data' class="box">
