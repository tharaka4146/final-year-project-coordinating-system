    ...
    -->
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                $sql = "SELECT * FROM researchWork WHERE kduEmail ='" . $_SESSION['uname'] . "' and review != 0";
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Upload research Work in pdf form</h1>
                    ...
                    <center>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <form method='post' action='../databases/uploadResearchWorkBackEnd.php' enctype='multipart/form-data' class="box">
