...
$sql = "SELECT count(*) as countSend FROM $formName WHERE (supervisor1 = '" . $name . "')";
$result = $con->query($sql);
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Weekly Progress</h1>
                    ...
                    <div class="row">
                        ...
                        for ($i = 0; $i < $countSend; ++$i) {
                            ...
                            $sql = "SELECT * FROM $formName WHERE (supervisor1 = '" . $name . "') order by indexNo desc limit $i1 OFFSET $i";
                            $result = $con->query($sql);
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="hoverbox rounded-soft text-center">
                                                ...
                                                <div style=" position: absolute; top: 55%; left: 50%; transform: translate(-50%, -50%); color:white;" class="centered"><i><?php echo $firstName; ?></i></div>
                                                <div class="hoverbox-content bg-dark p-5 align-items-center" style="text-align: center;">

                                                    <div>
                                                        <h5 class="leasd text-white" style="margin: auto;">
                                                            <?php echo "$firstName" . ' ' . "$lastName"; ?></h5>
                                                        <br>
                                                        <h6 class="leasd text-white"><?php echo $projectTitle; ?></h6>
                                                        <br>
                                                        <a class="btn btn-primary btn-md mt-1" href="weeklyProgressSupervisor.php?kduEmail=<?php echo $kduEmail; ?>">View
                                                            submission</a>
                                                    </div>
