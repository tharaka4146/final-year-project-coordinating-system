...
if ($result->num_rows > 0) {
    ...
    $sql = "SELECT * FROM final WHERE indexNo = 1";
    $result = $con->query($sql);
...
$sql = "SELECT * FROM final WHERE supervisorEmail='" . $_SESSION['uname'] . "' and kduEmail = '" . $kduEmail . "'";
$result = $con->query($sql);
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Final Presentation + VIVA Marking Scheme</h1>
                                        ...
                                        <form method='POST'>
                                            ...
                                            <div class='card-body'>
                                                ...
                                                <div class='form-group row'>
                                                    ...
                                                    <div class='col-12 col-sm-8 col-lg-6'>
                                                        <input class='form-control' id='kduEmail' name='kduEmail' type='text' value="<?php echo $kduEmail; ?>">
                                            ...
                                            <center>
                                                ...
                                                <a href='#' class='btn btn-primary btn-icon-split'>
                                                    ...
                                                    <br>
                                                    <button type='submit' formaction='../databases/final.php' class='btn btn-primary btn-icon-split text' id='save'>Send marking</button>
                                                </a>
