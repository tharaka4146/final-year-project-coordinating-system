                    ...
                    <div class="row">
                        ...
                        for ($i = 0; $i < $countSend; ++$i) {
                            ...
                            for ($j = 0; $j < 2; ++$j) {
                                ...
                                $sql = "SELECT (mark1 + mark2 + mark3 + mark4 + mark5 + mark6 + mark7 + mark8 + mark9 + mark10 + mark11 + mark12 + mark13 + mark14 + mark15 + mark16 + mark17 + mark18) as sum from paper where kduEmail = '" . $admissionNo . "' order by indexNo desc limit $j1 OFFSET $j ";
                                $result = $con->query($sql);
                                            ...
                                            <div class="hoverbox rounded-soft text-center">
                                                ...
                                                <div class="hoverbox-content bg-dark p-5 align-items-center" style="text-align: center;">
                                                    ...
                                                    <div style="margin: auto;">
                                                        ...
                                                        <br>
                                                        <a class="btn btn-primary btn-md mt-1" href="paper.php?kduEmail=<?php echo $admissionNo; ?>">Go to marking scheme</a>
                                                    </div>
