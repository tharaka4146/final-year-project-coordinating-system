                                                    ...
                                                    <div>
                                                        ...
                                                        <form method="POST">
                                                            ...
                                                            <a class="btn btn-primary btn-md mt-1" href="viewInterim1.php?filename=<?php echo $kduEmail; ?>">View
                                                                submission</a>
                                                            <button type='submit' formaction='../databases/interim1Approve.php' class="btn btn-primary btn-md mt-1" id='send'>Approve</button>
                                                            <button type='submit' formaction='../databases/interim1Disapprove.php' class="btn btn-primary btn-md mt-1" id='send'>Disaprove</button>
                                                        </form>
                                                    </div>
