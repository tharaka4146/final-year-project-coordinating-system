                    ...
                    if (username != "" && password != "") {
                        $.ajax({
                            ...
                            success: function(response) {
                                var msg = "";
                                if (response == 1) {
                                    window.location = "homeStudent.php";
                                } else if (response == 2) {
                                    window.location = "homeCoordinator.php";
                                } else if (response == 3) {
                                    window.location = "homeSupervisor.php";
                                } else if (response == 0) {
                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block bg-ldogin-image" style="background-color: rgb(153, 153, 250);">
                                <img src="../img/login12.png" alt="" style="width: 103%;">
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user">
                                        ...
                                        <input type="button" class="btn btn-primary btn-user btn-block" value="Login" name="but_submit" id="but_submit" style="font-size:15px; background-color:#0e30a1;" />
                                    ...
                                    <div class="text-center">
                                        <a class="small" href="resetPassword.php">Forgot Password?</a><br><br>
                                        <label>Arc-Hive is a fully functional WebApp specialized in facilitating the Final Year Project Coordinating activities</label><br><br>
                                    </div>
                                </div>
                            </div>
                        </div>
