                            ...
                            <div class="page">
                                ...
                                <header class="page-cover" style="background: url(../img/background4.png);">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <h2 class="h4 mt-2 mb-0"> <?php echo $nameLec; ?></h2>
                                        <div class="my-1">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <div class="card card-fluid">
                                                    ...
                                                    <nav class="nav nav-tabs flex-column border-0">
                                                        <a href="lecsProfileInfo.php" class="nav-link">Profile</a>
                                            ...
                                            <div class="col-lg-8">
                                                ...
                                                <div class="alert alert-success alert-dismissible fade show" role="alert">
                                                    <strong>Password changed successfully !</strong> You should check in on some of those other settings.
                                                ...
                                                <div class="card card-fluid">
                                                    ...
                                                    <div class="card-body">
                                                        <!-- form -->
                                                        <form method="post" action="../databases/lecsProfileSecurity.php">
                                                            <!-- form row -->
