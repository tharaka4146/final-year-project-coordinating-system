...
$sql = "SELECT count(research.indexNo) as countSend FROM $formName inner join norm on research.kduEmail = norm.kduEmail WHERE research.send = 1 and norm.examiner1 = '" . $name . "'";
$result = $con->query($sql);
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Reseach Application Submissions</h1>
                    ...
                    <div class="row">
                        ...
                        for ($i = 0; $i < $countSend; ++$i) {
                            ...
                            $sql = "SELECT *, research.dateTime as dateTime, research.review as review FROM $formName inner join norm on research.kduEmail = norm.kduEmail WHERE research.send = '1' and norm.examiner1 = '" . $name . "' order by research.indexNo desc limit $i1 OFFSET $i";
                            $result = $con->query($sql);
                                            ...
                                            <div class="hoverbox rounded-soft text-center">
                                                ...
                                                <div class="hoverbox-content bg-dark p-5 align-items-center" style="text-align: center;">
                                                    ...
                                                    <div>
                                                        ...
                                                        <h6 class="leasd text-white" style="font-size:15px">
                                                            <?php echo $time; ?></h6>
                                                        <a class="btn btn-primary btn-md mt-1" href="researchApplicationSupervisor.php?kduEmail=<?php echo $kduEmail; ?>">View
                                                            submission</a>
                                                    </div>
