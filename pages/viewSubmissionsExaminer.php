...
$sql = "SELECT count(*) as countSend FROM norm WHERE send = 1 and examiner1 = '" . $name . "'";
$result = $con->query($sql);
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!--
                    <center>
                        <a class="btn btn-primary btn-md mt-1" href="../databases/normNext.php">Unlock all students next activity</a>
                    </center>
...
-->
                    ...
                    <div class="row">
                        ...
                        for ($i = 0; $i < $countSend; ++$i) {
                            ...
                            $sql = "SELECT * FROM $formName WHERE send = '1' and examiner1 = '" . $name . "' order by indexNo desc limit $i1 OFFSET $i";
                            $result = $con->query($sql);
                                            ...
                                            <div class="hoverbox rounded-soft text-center">
                                                ...
                                                <div class="hoverbox-content bg-dark p-5 align-items-center" style="text-align: center;">
                                                    ...
                                                    <div style="margin: auto;">
                                                        ...
                                                        <h6 class="leasd text-white" style="font-size:15px">
                                                            <?php echo $time; ?></h6>
                                                        <a class="btn btn-primary btn-md mt-1" href="normViewExaminer.php?kduEmail=<?php echo $kduEmail; ?>">View
                                                            submission</a>
                                                    </div>
