...
$sql = "SELECT count(*) as countSend FROM $formName";
$result = $con->query($sql);
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Student profiles</h1>
                    ...
                    <div class="row">
                        ...
                        for ($i = 0; $i < $countSend; ++$i) {
                            ...
                            $sql = "SELECT * from student order by kduEmail desc limit $i1 OFFSET $i ";
                            $result = $con->query($sql);
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="hoverbox rounded-soft text-center" style="background-color: #5C73F2;">
                                                <img class="img-fluid" src="../img/profilePics/<?php echo "$kduEmail" ?>.jpg" alt="" style="position: relative; text-align: center; filter: brightness(0.7);">
                                                <div style=" position: absolute; top: 53%; left: 50%; transform: translate(-50%, -50%); color:white;" class="centered"><?php echo $admissionNo; ?></div>
                                                ...
                                                <div class="hoverbox-content bg-dark p-5 align-items-center" style="text-align: center;">
                                                    <div>
                                                        <form method="POST">
                                                            ...
                                                            <a style=" position: absolute; top: 45%; left: 31%;" class="btn btn-primary btn-md mt-1" href="profileInfoSupervisor.php?kduEmail=<?php echo $kduEmail; ?>">View profile</a>
                                                        </form>
                                                    </div>
                                                </div>
