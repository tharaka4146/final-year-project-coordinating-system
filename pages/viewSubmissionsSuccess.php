...
$sql = "SELECT count(*) as countSend FROM $formName WHERE send = 1";
$result = $con->query($sql);
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="viewPresentation.php">
                    <i class="fas fa-fw fa-chart-area"></i>
                    <span>View student marking</span></a>
            </li>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="alert alert-success alert-dismissible fade show" role="alert">
                        <strong>Form approved!</strong> Now the student can go to the next activity.
                    ...
                    <div class="row">
                        ...
                        $sql = "SELECT *  FROM $formName WHERE send = 1";
                        $result = $con->query($sql);
                        ...
                        for ($i = 0; $i < $countSend; ++$i) {
                            ...
                            $sql = "SELECT * FROM $formName WHERE send = '1' order by indexNo desc limit $i1 OFFSET $i";
                            $result = $con->query($sql);
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="hoverbox rounded-soft text-center">
                                                ...
                                                <!--<div style=" position: absolute; top: 55%; left: 50%; transform: translate(-50%, -50%); color:white;" class="centered"><?php echo $late; ?></div>-->
                                                <div class="hoverbox-content bg-dark p-5 align-items-center" style="text-align: center;">

                                                    <div>
                                                        <h5 class="leasd text-white"><?php echo "$firstName" . ' ' . "$lastName"; ?></h5>
                                                        <br>
                                                        <h6 class="leasd text-white"><?php echo $projectTitle; ?></h6>
                                                        <br>
                                                        <h6 class="leasd text-white" style="font-size:15px"><?php echo $date; ?></h6>
                                                        <h6 class="leasd text-white" style="font-size:15px"><?php echo $time; ?></h6>
                                                        <a class="btn btn-primary btn-md mt-1" href="normView.php?kduEmail=<?php echo $kduEmail; ?>">View submission</a>
                                                    </div>
