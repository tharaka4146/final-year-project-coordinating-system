    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                $sql = "SELECT * FROM paperSubmission WHERE kduEmail ='" . $_SESSION['uname'] . "'";
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Upload Paper in pdf form</h1>
                    ...
                    <center>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <form method='post' action='uploadPaperBackEnd.php' enctype='multipart/form-data' class="box">
