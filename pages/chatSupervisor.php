...
$sql = "SELECT count((kduEmail)) as countSend FROM norm where (s1 = '" . $name . "' or s2 = '" . $name . "')";
$result = $con->query($sql);
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Student Messaging</h1>
                    ...
                    <div class="row">
                        ...
                        for ($i = 0; $i < $countSend; ++$i) {
                            ...
                            $sql = "SELECT * from                              norm where (s1 = '" . $name . "' or s2 = '" . $name . "') order by kduEmail desc limit $i1 OFFSET $i ";
                            $result = $con->query($sql);
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="hoverbox rounded-soft text-center" style="background-color: #5C73F2;">
                                                ...
                                                <div style=" position: absolute; top: 40%; left: 50%; transform: translate(-50%, -50%); color:white;" class="centered"><?php echo $admissionNo; ?></div>
                                                <div style=" position: absolute; top: 55%; left: 50%; transform: translate(-50%, -50%); color:white;" class="centered"><?php echo $studentName; ?></div>
                                                ...
                                                <div class="hoverbox-content bg-dark p-5 align-items-center" style="text-align: center;">
                                                    <div>
                                                        <form method="POST">
                                                            ...
                                                            <a style=" position: absolute; top: 45%; left: 31%;" class="btn btn-primary btn-md mt-1" href="https://arc-hive-chat-2a21d.web.app/">Send Message</a>
                                                        </form>
                                                    </div>
                                                </div>
