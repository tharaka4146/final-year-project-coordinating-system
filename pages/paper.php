...
if ($result->num_rows > 0) {
    ...
    $sql = "SELECT * FROM paper WHERE indexNo = 1";
    $result = $con->query($sql);
...
$sql = "SELECT * FROM paper WHERE supervisorEmail='" . $_SESSION['uname'] . "' and kduEmail = '" . $kduEmail . "'";
$result = $con->query($sql);
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Paper Publication Marking Scheme</h1>
                                        ...
                                        <form method='POST'>
                                            ...
                                            <center>
                                                ...
                                                <a href='#' class='btn btn-primary btn-icon-split'>
                                                    ...
                                                    <br>
                                                    <button type='submit' formaction='../databases/paper.php' class='btn btn-primary btn-icon-split text' id='save'>Send marking</button>
                                                </a>
