...
<div id="content">
    ...
    <!-- End of Topbar -->
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Norm submissions</h1>
                                            ...
                                            <div class="hoverbox rounded-soft text-center" >
                                                ...
                                                <div class="hoverbox-content bg-dark p-5 align-items-center" style="text-align: center;">
                                                    ...
                                                    <div style="margin: auto;">
                                                        ...
                                                        <h6 class="leasd text-white" style="font-size:15px">
                                                            <?php echo $time; ?></h6>
                                                        <a class="btn btn-primary btn-md mt-1" href="normView.php?kduEmail=<?php echo $kduEmail; ?>">View
                                                            submission</a>
                                                    </div>
