...
$formName = 'thesisSubmissionFinal';
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        for ($i = 0; $i < $countSend; ++$i) {
                            ...
                            $sql = "SELECT norm.kduEmail as kduEmail, norm.admissionNo as admissionNo, norm.firstName as firstName, norm.lastName as lastName, norm.projectTitle as projectTitle, $formName.dateTime dateTime, $formName.review as review  FROM $formName inner join norm on $formName.kduEmail = norm.kduEmail where $formName.review != 0 and norm.examiner1 = '" . $name . "' order by $formName.indexNo desc limit $i1 OFFSET $i ";
                            $result = $con->query($sql);
                                                    ...
                                                    <div>
                                                        ...
                                                        <form method="POST">
                                                            ...
                                                            <a class="btn btn-primary btn-md mt-1" href="viewThesis.php?filename=<?php echo $kduEmail; ?>">View
                                                                submission</a>
                                                            <button type='submit' formaction='../databases/thesisFinalApprove.php' class="btn btn-primary btn-md mt-1" id='send'>Approve</button>
                                                            <button type='submit' formaction='../databases/thesisFinalDisapprove.php' class="btn btn-primary btn-md mt-1" id='send'>Disaprove</button>
                                                        </form>
                                                    </div>
