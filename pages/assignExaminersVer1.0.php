    ...
    <div class="form-row" style="width: 100%; margin-top: 00px; backgrsound-color: rgb(159, 207, 174); padding-top: 10px; padding-bottom: 10px;padding-left: 10px;padding-right: 10px;">
                        ...
                        ?>
                            ...
                            <tr>
                                ...
                                <td style="width:150px;">
                                    ...
                                    <?php
                                    echo '<a data-toggle="tooltip" data-placement="right" title=' . $row["firstName"] . '&nbsp;' . $row["lastName"] . ' >' . $row["admissionNo"] . '</a>' . '<br>';
                                    ?>
                                ...
                                $supervisorList = array("examiner1", "examiner2");
                                ...
                                ?>
                                    ...
                                    <td>
                                        ...
                                        <select class="custom-select custom-select-sm" onclick="calculate(), colorChange('<?php echo $admissionNo ?>','<?php echo $b ?>')" id="<?php echo $admissionNo . $b; ?>" style="width: 100%; color:#232b2b; background-color:	#f2f1e7">
                                            ...
                                            <optgroup value="0" label="assigned">
        ...
        <div class="sticky col-lg-5">
            ...
            <table class="table-sortable table-dark table-hover" style="width: 100%!important; text-align: center;" cellpadding="4px" border="1">
                ...
                <thead>
                    <tr>
                        <th style="width:60% ;">Examiner's name</th>
                        <th style="width:10% ;">Total</th>
                        <th style="width:10% ;">E1</th>
                        <th style="width:10% ;">E2</th>
                    </tr>
                </thead>
            ...
            <script>
                ...
                function calculate() {
                    ...
                    for ($g = 0; $g < <?php echo $countSupervisors ?>; $g++) {
                        ...
                        document.getElementById(supervisorsArray2[$g] + '1').innerHTML = (num12 + num22);
