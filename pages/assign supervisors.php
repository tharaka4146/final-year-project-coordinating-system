...
<html>
    ...
    <head>
        ...
        <link rel="stylesheet" href="css/stysle.css">
        <link rel="stylesheet" href="css/styleSort.css">
        <link rel="stylesheet" type="text/css" href="styleSort.css">
    ...
    <div class="form-row"
        ...
        <div class="col-lg-7">
            ...
            <table style=" width: 100%!important; text-align: center;" border = "1" class="table table-dark table-striped table-hover">
                ...
                <tbody>
                    ...
                    <?php
                        ...
                        $sql = "SELECT count(distinct(area)) as areaCount FROM norm";
                        ...
                        for ($t = 0; $t < $areaCount; $t++) {
                            ...
                            $sql = "SELECT distinct(area) as areas FROM norm order by indexNo limit $t1 OFFSET $t";
                            $result = $conn->query($sql);
                ...
                <?php
                    ...
                    $sql = "SELECT count(indexNo) as countStudents FROM norm where area = '$areas2'";
                    $result = $conn->query($sql);
                    ...
                    for ($a = 0; $a < $countStudents; $a++) {
                        ...
                        $sql = "SELECT * FROM norm  where area = '$areas2' order by indexNo limit $a1 OFFSET $a";
                        $result = $conn->query($sql);
...
<tbody>
        ...
        <div class="sticky col-lg-5">
            ...
            <table class="table-dark  table-hover table-sortable" style=" width: 100%!important; text-align: center;" cellpadding="4px" border="1">

                <tr style="backgdround-color: ghostwhite; height:">
...
$sql = "SELECT count(indexNo) as countStudents2 FROM norm";
$result = $conn->query($sql);
...
for ($e = 0; $e < $countStudents2; $e++) {
    for ($f = 0; $f < 3; $f++) {
        ...
        $sql = "SELECT * FROM norm order by indexNo limit $e1 OFFSET $e";
        $result = $conn->query($sql);
...
?>
var isEmptyq = document.getElementById(supervisorsArray2[<?php echo $g ?>]+<?php echo $h1 ?>);
window.alert[isEmptyq];
if(isEmptyq == 1){
} else{
document.getElementById(supervisorsArray2[<?php echo $g ?>]+<?php echo $h1 ?>).innerHTML = "0";
