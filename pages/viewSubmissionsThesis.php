...
$formName = 'thesisSubmission';

$sql = "SELECT count($formName.kduEmail) as countSend FROM $formName inner join norm on $formName.kduEmail = norm.kduEmail where $formName.review != 0 and norm.examiner1 = '" . $name . "'";
$result = $con->query($sql);
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        for ($i = 0; $i < $countSend; ++$i) {
                            ...
                            $sql = "SELECT norm.kduEmail as kduEmail, norm.admissionNo as admissionNo, norm.firstName as firstName, norm.lastName as lastName, norm.projectTitle as projectTitle, thesisSubmission.dateTime dateTime, thesisSubmission.deadLine as deadLine, thesisSubmission.review as review  FROM $formName inner join norm on $formName.kduEmail = norm.kduEmail where thesisSubmission.review != 0  and norm.examiner1 = '" . $name . "' order by thesisSubmission.indexNo desc limit $i1 OFFSET $i ";
                            $result = $con->query($sql);
                                                ...
                                                <div class="hoverbox-content bg-dark p-5 align-items-center" style="text-align: center;">
                                                    ...
                                                    <div>
                                                        ...
                                                        <form method="POST">
                                                            ...
                                                            <a class="btn btn-primary btn-md mt-1" href="viewThesis.php?filename=<?php echo $kduEmail; ?>">View
                                                                submission</a>
                                                            <button type='submit' formaction='../databases/thesisApprove.php' class="btn btn-primary btn-md mt-1" id='send'>Approve</button>
                                                            <button type='submit' formaction='../databases/thesisDisapprove.php' class="btn btn-primary btn-md mt-1" id='send'>Disaprove</button>
                                                        </form>
                                                    </div>
