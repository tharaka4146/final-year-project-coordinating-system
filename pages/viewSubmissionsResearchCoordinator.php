...
$sql = "SELECT count(research.indexNo) as countSend FROM $formName inner join norm on research.kduEmail = norm.kduEmail WHERE research.send = 1";
$result = $con->query($sql);
...
<head>
    ...
    <title>Reseach Application Submissions</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        for ($i = 0; $i < $countSend; ++$i) {
                            ...
                            $sql = "SELECT *, research.dateTime as dateTime, research.review as review FROM $formName inner join norm on research.kduEmail = norm.kduEmail WHERE research.send = '1' order by research.indexNo desc limit $i1 OFFSET $i";
                            $result = $con->query($sql);
                                            ...
                                            <div class="hoverbox rounded-soft text-center">
                                                ...
                                                <div class="hoverbox-content bg-dark p-5 align-items-center" style="text-align: center;">
                                                    ...
                                                    <div>
                                                        ...
                                                        <h6 class="leasd text-white" style="font-size:15px">
                                                            <?php echo $time; ?></h6>
                                                        <a class="btn btn-primary btn-md mt-1" href="researchApplicationCoordinator.php?kduEmail=<?php echo $kduEmail; ?>">View
                                                            submission</a>
                                                    </div>
