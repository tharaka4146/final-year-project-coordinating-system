...
$formName = 'projectproposal';

$sql = "SELECT count(norm.kduEmail) as countSend FROM $formName inner join norm on projectproposal.kduEmail = norm.kduEmail  where projectproposal.review != 0 and norm.examiner1 = '" . $name . "'";
$result = $con->query($sql);
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800"><?php echo "$formName" . ' '; ?>submissions</h1>
                    ...
                    <div class="row">
                        ...
                        for ($i = 0; $i < $countSend; ++$i) {
                            ...
                            $sql = "SELECT norm.kduEmail as kduEmail, norm.admissionNo as admissionNo, norm.firstName as firstName, norm.lastName as lastName, norm.projectTitle as projectTitle, projectproposal.dateTime dateTime, projectproposal.try as try, projectproposal.review as review  FROM $formName inner join norm on $formName.kduEmail = norm.kduEmail where projectproposal.review != 0 and norm.examiner1 = '" . $name . "' order by projectproposal.indexNo desc limit $i1 OFFSET $i ";
                            $result = $con->query($sql);
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="hoverbox rounded-soft text-center">
                                                ...
                                                <div style=" position: absolute; top: 75%; left: 50%; transform: translate(-50%, -50%); color:#8C030E;" class="centered"><?php echo $try; ?></div>
                                                
                                                <div class="hoverbox-content bg-dark p-5 align-items-center" style="text-align: center;">

                                                    <div style="margin: auto; margin-top:-20%;">
                                                        ...
                                                        <form method="POST">
                                                            ...
                                                            <a class="btn btn-primary btn-md mt-1" href="viewProjectProposal.php?filename=<?php echo $kduEmail; ?>">View
                                                                submission</a>
                                                            <button type='submit' formaction='../databases/projectProposalApprove.php' class="btn btn-primary btn-md mt-1" id='send'>Approve</button>
                                                            <button type='submit' formaction='../databases/projectProposalDisapprove.php' class="btn btn-primary btn-md mt-1" id='send'>Disaprove</button>
                                                        </form>
                                                    </div>
