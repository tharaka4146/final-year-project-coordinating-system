...
<div id="content">
    ...
    <!-- End of Topbar -->
                ...
                $sql = "SELECT * FROM thesisSubmissionFinal WHERE kduEmail ='" . $_SESSION['uname'] . "' and review != 0";
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Upload finalthesis in pdf form</h1>
                    ...
                    <center>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <form method='post' action='../databases/uploadThesisBackEndFinal.php' enctype='multipart/form-data' class="box">
                                    ...
                                    <div class="box__input">
                                        ...
                                        <label for="file">
                                            <span class="box__dragndrop"><?php echo $message ?></span>
                                            <span></span>
                                        </label>
                                        ...
                                        <input type='submit' name='submit' class='btn btn-primary' <?php echo $disabled ?>>
