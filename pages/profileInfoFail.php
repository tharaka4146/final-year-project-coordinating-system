                                ...
                                <div class="page">
                                    ...
                                    <header class="page-cover" style = "background: url(../img/background4.png);">
                                        <div class="text-center">
                                            <a href="user-profile.html" class="user-avatar user-avatar-xl"><img src="https://uselooper.com/assets/images/avatars/profile.jpg" alt=""></a>
                                        ...
                                        <div class="page-section">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <div class="card card-fluid">
                                                        ...
                                                        <nav class="nav nav-tabs flex-column border-0">
                                                            ...
                                                            <a href="profileSecurity.php" class="nav-link">Security</a>
                                                        </nav>
                                                        <!-- /.nav -->
                                                    </div>
                                                    <!-- /.card -->
                                                ...
                                                <div class="alert alert-warning alert-dismissible fade show" role="alert">
                                                    <strong>Error updating information !</strong> try loging out  and loging in again
                                                ...
                                                <script>
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div class="media mb-3">
                                                                ...
                                                                <div class="user-avatar user-avatar-xl fileinput-button">
                                                                    <div class="fileinput-button-label"> Change photo
                                                                    </div><img src="https://uselooper.com/assets/images/avatars/profile.jpg" alt=""> <input id="fileupload-avatar" type="file" name="avatar">
                                                                </div>
                                                                <!-- /avatar -->
                                                                <!-- .media-body -->
                                                                <div class="media-body pl-3">
                                                                    ...
                                                                    <p class="card-text">
                                                                        <small>JPG, GIF or PNG 400x400, &lt; 2
                                                                            MB.</small>
                                                                    </p>
                                                    ...
                                                    <div class="card card-fluid">
                                                        ...
                                                        <div class="card-body">
                                                            <!-- form -->
                                                            <form method="post" action = "../databases/profileAccount.php">
                                                                <!-- form row -->
                                                                <div class="form-row">
                                                                    <!-- form column -->
                                                                    <div class="col-md-6 mb-3">
                                                                        <label for="input01">First Name</label> <input type="text" class="form-control" name ="firstName" id="firstName" value="<?php echo $firstName; ?>" required="">
                                                                    </div>
                                                                    <!-- /form column -->
                                                                    <!-- form column -->
                                                                    <div class="col-md-6 mb-3">
                                                                        <label for="input02">Last Name</label> <input type="text" class="form-control" name = "lastName" id="lastName" value="<?php echo $lastName; ?>" required="">
                                                                    </div>
                                                                    <!-- /form column -->
                                                                </div>
                                                                <!-- /form row -->
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="input03">Admission No</label> <input type="text" class="form-control" name = "admissionNO" id="admissionNO" value = "<?php echo $admissionNO; ?>" placeholder="D / BCS / 19 / 0018" required="">
                                                                </div>
                                                                <!-- /.form-group -->
