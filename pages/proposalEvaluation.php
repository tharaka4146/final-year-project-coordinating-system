...
if ($result->num_rows > 0) {
    ...
    $sql = "SELECT * FROM proposalEvaluation WHERE indexNo = 1";
    $result = $con->query($sql);
...
$sql = "SELECT * FROM proposalEvaluation WHERE supervisorEmail='" . $_SESSION['uname'] . "' and kduEmail = '" . $kduEmail . "'";
$result = $con->query($sql);
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Project Proposal Presentation Marking Scheme</h1>
                                        ...
                                        <form method='POST'>
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr class="row100 body">
                                                                        ...
                                                                        <td class="cell100 column2">Excellent use of the
                                                                            literature (more than 10 proposalEvaluations)</td>
                                                                        <td class="cell100 column3">Good use of the
                                                                            literature (10 proposalEvaluation</td>
                                                                        <td class="cell100 column4">Good use of the
                                                                            literature (5 proposalEvaluations) to identify the knowledge
                                                                        </td>
                                            ...
                                            <center>
                                                ...
                                                <a href='#' class='btn btn-primary btn-icon-split'>
                                                    ...
                                                    <br>
                                                    <button type='submit' formaction='../databases/proposalEvaluation.php' class='btn btn-primary btn-icon-split text' id='save'>Send marking</button>
                                                </a>
