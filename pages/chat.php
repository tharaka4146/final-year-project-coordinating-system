...
$sql = "SELECT count(distinct(name)) as countSend FROM $formName where (name = '" . $s1 . "' or name = '" . $s2 . "')";
$result = $con->query($sql);
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Supervisor messaging</h1>
                    ...
                    <div class="row">
                        ...
                        for ($i = 0; $i < $countSend; ++$i) {
                            ...
                            $sql = "SELECT distinct(name) as name, kduEmail, indexNo from $formName  where (name = '" . $s1 . "' or name = '" . $s2 . "') order by kduEmail desc limit $i1 OFFSET $i ";
                            $result = $con->query($sql);
                                                ...
                                                <div class="hoverbox-content bg-dark p-5 align-items-center" style="text-align: center;">
                                                    <div style="margin: auto;">
                                                        <form method="POST">
                                                            ...
                                                            <a style=" position: absolute; top: 45%; left: 31%;" class="btn btn-primary btn-md mt-1" href="https://arc-hive-chat-2a21d.web.app/">Message</a>
                                                        </form>
                                                    </div>
                                                </div>
