        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Available Marking</h1>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="hoverbox rounded-soft text-center">
                                            <img class="img-fluid" alt="" style="position: relative; text-align: center; filter: blur(0px);">
                                            <div style=" position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); color:white;" class="centered">Proposal Evaluation</div>
                                            <div class="hoverbox-content bg-dark p-5 align-items-center" style="text-align: center;">

                                                <div style="margin: auto;">
                                                    <a class="btn btn-primary btn-md mt-1" href="viewMarkingCommon.php?formName=proposalEvaluation">View markings</a>
                                                </div>
                            ...
                            <div class="card mb-3" style=" background-color:<?php echo $color; ?>;">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="hoverbox rounded-soft text-center">
                                            <img class="img-fluid" alt="" style="position: relative; text-align: center; filter: blur(0px);">
                                            <div style=" position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); color:white;" class="centered">Progress review 1</div>
                                            <div class="hoverbox-content bg-dark p-5 align-items-center" style="text-align: center;">

                                                <div style="margin: auto;">
                                                    <a class="btn btn-primary btn-md mt-1" href="viewMarkingCommon.php?formName=progressReview1">View markings</a>
                                                </div>
                            ...
                            <div class="card mb-3" style=" background-color:<?php echo $color; ?>;">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="hoverbox rounded-soft text-center">
                                            <img class="img-fluid" alt="" style="position: relative; text-align: center; filter: blur(0px);">
                                            <div style=" position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); color:white;" class="centered">Progress review 2</div>
                                            <div class="hoverbox-content bg-dark p-5 align-items-center" style="text-align: center;">

                                                <div style="margin: auto;">
                                                    <a class="btn btn-primary btn-md mt-1" href="viewMarkingCommon.php?formName=progressReview2">View markings</a>
                                                </div>
                            ...
                            <div class="card mb-3" style=" background-color:<?php echo $color; ?>;">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="hoverbox rounded-soft text-center">
                                            <img class="img-fluid" alt="" style="position: relative; text-align: center; filter: blur(0px);">
                                            <div style=" position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); color:white;" class="centered">Thesis</div>
                                            <div class="hoverbox-content bg-dark p-5 align-items-center" style="text-align: center;">

                                                <div style="margin: auto;">
                                                    <a class="btn btn-primary btn-md mt-1" href="viewMarkingCommon.php?formName=thesis">View markings</a>
                                                </div>
                            ...
                            <div class="card mb-3" style=" background-color:<?php echo $color; ?>;">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="hoverbox rounded-soft text-center">
                                            <img class="img-fluid" alt="" style="position: relative; text-align: center; filter: blur(0px);">
                                            <div style=" position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); color:white;" class="centered">Paper preseantation</div>
                                            <div class="hoverbox-content bg-dark p-5 align-items-center" style="text-align: center;">

                                                <div style="margin: auto;">
                                                    <a class="btn btn-primary btn-md mt-1" href="viewMarkingCommon.php?formName=paper">View markings</a>
                                                </div>
                            ...
                            <div class="card mb-3" style=" background-color:<?php echo $color; ?>;">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="hoverbox rounded-soft text-center">
                                            <img class="img-fluid" alt="" style="position: relative; text-align: center; filter: blur(0px);">
                                            <div style=" position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); color:white;" class="centered">Final Presentation + VIVA</div>
                                            <div class="hoverbox-content bg-dark p-5 align-items-center" style="text-align: center;">

                                                <div style="margin: auto;">
                                                    <a class="btn btn-primary btn-md mt-1" href="viewMarkingCommon.php?formName=final">View markings</a>
                                                </div>
