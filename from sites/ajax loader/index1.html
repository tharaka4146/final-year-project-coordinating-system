...
<head>
    ...
    <link rel="shortcut icon" href="https://foxythemes.net/preview/products/beagle/assets/img/logo-fav.png">
    <title>Beagle</title>
    ...
    <div class="be-wrapper">
        <nav class="navbar navbar-expand fixed-top be-top-header">
            <div class="container-fluid">
                ...
                <div class="page-title"><span>Loaders</span></div>
                <div class="be-right-navbar">
                    <ul class="nav navbar-nav float-right be-user-nav">
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" role="button" aria-expanded="false"><img src="assets/img/avatar.png" alt="Avatar"><span class="user-name">Túpac Amaru</span></a>
        ...
        <div class="be-left-sidebar">
            <div class="left-sidebar-wrapper"><a class="left-sidebar-toggle" href="#">Loaders</a>
                            ...
                            <ul class="sidebar-elements">
                                ...
                                <li class="parent"><a href="#"><i class="icon mdi mdi-layers"></i><span>Pages</span></a>
                                    <ul class="sub-menu">
                                        ...
                                        <li class="active"><a href="pages-loaders.html"><span class="badge badge-primary float-right">New</span>Loaders</a>
                                        </li>
        ...
        <div class="be-content">
            <div class="page-head">
                <h2 class="page-head-title">Page Loaders</h2>
                <nav aria-label="breadcrumb" role="navigation">
                    <ol class="breadcrumb page-head-nav">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item"><a href="#">Category</a></li>
                        <li class="breadcrumb-item active">Page Loaders</li>
                    </ol>
                </nav>
            </div>
            <div class="main-content container-fluid">
                <div class="row">
                    <div class="col-12 col-lg-7 offset-lg-2">
                        <div class="card">
                            <div class="card-header"><span class="title">Using loaders classes</span></div>
                            <div class="card-body">
                                <p>To use the effect you need a minimum structure consisting of the following elements:</p>
                                <ol>
                                    <li>
                                        <p>The parent element with the <code>be-loading</code> class</p>
                                    </li>
                                    <li>
                                        <p>Directly inside <code>be-loading</code> you have to include the <code>be-spinner</code> element which contains the SVG.</p>
                                    </li>
                                </ol>
                                <p>Then to trigger the effect, add the <code>be-loading-active</code> class on the <code>be-loading</code> element.</p>
                            </div>
...
&lt;/div&gt;
                ...
                <div class="row">
                    <div class="col-lg-7 offset-lg-2">
                        <div class="card card-flat be-loading text-center">
                            ...
                            <div class="card-body">
                                <p>Aliquam posuere volutpat turpis, ut euimod diam pellentesque at. Sed sit amet nulla a dui dignisim euismod. Morbi luctus elementum dictum. Donec convallis mattis elit id varius. Quisque facilisis sapien quis mauris, erat
                                    condimentum.
                                </p>
    ...
    <script src="https://foxythemes.net/preview/products/beagle/assets/lib/prettify/prettify.js" type="text/javascript"></script>
