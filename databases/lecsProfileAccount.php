...
if ($result->num_rows > 0) {
    if ($row = $result->fetch_assoc()) {
        $sql = "UPDATE supervisors SET name = '" . $name . "', indexNo = '" . $indexNo . "', institution = '" . $institution . "', contactNo = '" . $contactNo . "' WHERE kduEmail= '" . $_SESSION['uname'] . "'";
    ...
    header('Location:../pages/lecsProfileInfoFail.php');
}
