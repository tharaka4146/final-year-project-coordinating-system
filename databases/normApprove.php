...
$sql = "SELECT * FROM norm WHERE kduEmail ='".$kduEmail."'";
...
if ($result->num_rows > 0) {
    if ($row = $result->fetch_assoc()) {
        ...
        */
        ...
        $sql = "UPDATE norm SET review = '1', message2 = '$message2' WHERE kduEmail = '".$kduEmail."'";
        ...
        $sql = "UPDATE student SET current = '2' WHERE kduEmail = '".$kduEmail."'";
...
header('Location:../pages/viewSubmissionsSuccess.php');
