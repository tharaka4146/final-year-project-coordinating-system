...
! function (t) {
    ...
    Te.mixin({
        ...
        fgSegHtml: function (t, e) {
            ...
            return h.unshift("fc-time-grid-event", "fc-v-event"), s.isMultiDayEvent(o) ? (t.isStart || t.isEnd) && (n = this.getEventTimeText(t), i = this.getEventTimeText(t, "LT"), r = this.getEventTimeText(t, null, !1)) : (n = this.getEventTimeText(o), i = this.getEventTimeText(o, "LT"), r = this.getEventTimeText(o, null, !1)), '<a class="' + h.join(" ") + '"' + (o.url ? ' href="' + ht(o.url) + '"' : "") + (c ? ' style="' + c + '"' : "") + '><div class="fc-content" style = "color:' + ht(o.title) + '">' + (n ? '</div><div class="fc-time" data-start="' + ht(r) + '" data-full="' + ht(i) + '"><span>' + ht(n) + "</span></div>" : "") + (o.title ? '<div class="fc-title">' + ' <b><br>Student&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b> : ' + ht(o.title) + ' <b><br>Examiner 1 </b> : ' + ht(o.temp) + ' <b><br>Examiner 2 </b> : ' + ht(o.examiner2) + " " : "") + (o.name ? ' <b><br>Location</b> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: ' + ht(o.name) + "</div>" : "") + '</div><div class="fc-bg"/>' + (u ? '<div class="fc-resizer fc-end-resizer" />' : "") + "</a>"
        },
