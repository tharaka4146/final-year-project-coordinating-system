...
<head>
    ...
    <title>Presesntation Schedule</title>
        ...
        ! function(t) {
            ...
            Te.mixin({
                ...
                fgSegHtml: function(t, e) {
                    ...
                    return h.unshift("fc-time-grid-event", "fc-v-event"), s.isMultiDayEvent(o) ? (t.isStart || t.isEnd) && (n = this.getEventTimeText(t), i = this.getEventTimeText(t, "LT"), r = this.getEventTimeText(t, null, !1)) : (n = this.getEventTimeText(o), i = this.getEventTimeText(o, "LT"), r = this.getEventTimeText(o, null, !1)), '<a class="' + h.join(" ") + '"' + (o.url ? ' href="' + ht(o.url) + '"' : "") + (c ? ' style="' + c + '"' : "") + '><div class="fc-content">' + (n ? '</div><div class="fc-time" data-start="' + ht(r) + '" data-full="' + ht(i) + '"><span>' + ht(n) + "</span></div>" : "") + (o.title ? '<div class="fc-title">' + '<br>Student&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : ' + ht(o.title) + " " : "") + (o.name ? '<br>Location&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: ' + ht(o.name) + "</div>" : "") + (o.examiner1 ? 'Examiner1&nbsp;&nbsp;&nbsp;: ' + ht(o.examiner1) + "</div>" : "") + (o.examiner2 ? '<br>Examiner2&nbsp;&nbsp;&nbsp;: ' + ht(o.examiner2) + "</div>" : "") + '</div><div class="fc-bg"/>' + (u ? '<div class="fc-resizer fc-end-resizer" />' : "") + "</a>"
                },
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="../../pages/homeStudent.php">
